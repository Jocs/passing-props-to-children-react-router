...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			key: 'handleAddIterm',
			value: function handleAddIterm() {
				var name = prompt('what\'s your name?');
				if (name !== '') {
					this.setState({
						lists: this.state.lists.concat({ name: name })
					});
				}
			}
		}, {
			key: 'removeIterm',
			value: function removeIterm(name) {
				var _this2 = this;

				this.setState({
					lists: this.state.lists.filter(function (l) {
						return name !== l.name;
					})
				}, function () {
			...
			value: function render() {
				var navIterms = this.state.lists.map(function (l, i) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'button',
							{ onClick: this.handleAddIterm.bind(this) },
							'添加成员'
						)
					),
					_react2.default.createElement(
					...
					this.props.children && _react2.default.cloneElement(this.props.children, { onRemoveIterm: this.removeIterm.bind(this) })
				);
			}
		}]);
	...
	var Detail = function (_Component2) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Route,
			{ path: '/', component: App },
			_react2.default.createElement(_reactRouter.Route, { path: '/:name', component: Detail })
		)
